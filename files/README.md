...
`2.0.2`. For sbt builds, it can be added with
`libraryDependencies += "com.swoval" % "file-tree-views" % "2.0.2"`.
...
To use, add `"swoval_file_tree_views": "2.0.2"` to your package.json file.
