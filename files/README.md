...
Javadocs may be found at [files-jvm](https://swoval.github.io/docs/swoval/2.0.6/jvm/api).
Scaladocs for scala.js may be found at [files-js](https://swoval.github.io/docs/swoval/2.0.6/js/api).
...
`2.0.6`. For sbt builds, it can be added with
`libraryDependencies += "com.swoval" % "file-tree-views" % "2.0.6"`.
...
that exports a subset of the public api as documented in [files-jvm](https://swoval.github.io/docs/swoval/2.0.6/jvm/api).
...
can be found here:
[javascript public api](https://swoval.github.io/docs/swoval/2.0.6/js/api/com/swoval/files/node/index.html).

To use, add `"swoval_file_tree_views": "2.0.6"` to your package.json file.
