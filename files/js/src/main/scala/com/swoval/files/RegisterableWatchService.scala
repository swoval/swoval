 ...
 * with a [[RegisterableWatchService.register]] method. This is because [[https://docs.oracle.com/javase/7/docs/api/java/nio/file/Path.html.register]]
 * does not work on custom watch services.
 */
trait RegisterableWatchService extends java.nio.file.WatchService {
