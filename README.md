...
Add
```
addSbtPlugin("com.swoval" %% "sbt-mac-watch-service" % "1.2.0-RC2")
```
to your project/plugins.sbt. To apply the plugin globally, add those commands to ~/.sbt/1.0/plugins/watch.sbt (creating the file if necessary). If you are running into issues with 1.2.0-RC2, the last stable release before some significant internal changes was `1.1.4`.
