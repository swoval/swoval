...
Usage
---
Add `addSbtPlugin("com.swoval" %% "sbt-mac-watch-service" % "1.1.3")` to your project/plugins.sbt. To apply the plugin globally, add that command to ~/.sbt/1.0/plugins/watch.sbt (creating the file if necessary).
